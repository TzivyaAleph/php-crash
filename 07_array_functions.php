...
// Split into chunks of 2 - each variable will be grouped to 2 elements
...
// Combine arrays (Keys & values) - use the first array as keys and the second as values
$a = ['green', 'red', 'yellow'];
...
// Map through array and create a new one- the first element is the value
